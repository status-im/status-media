export const categories = [
  {
    category: 'status',
    display: 'Status Podcasts',
    subtitle: 'Everything related the Status Networks, blockchain and crypto'
  }
]
...
export const podcasts = [
  ...
  },
  {
    ...
    featured: ['#299', "#75", '#76',  '#77', '#300', '#301', '#302', '#303'],
    videos: []
  },
  {
    category: 'featured',
    name: 'Epicenter',
    creator: "Epicenter Media Ltd.",
